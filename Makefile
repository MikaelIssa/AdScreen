...
SRC = main.cpp src/User.cpp src/Card.cpp src/Admin.cpp src/Floor.cpp						# Source code files (when creating more source code files, you will need to add them here).
